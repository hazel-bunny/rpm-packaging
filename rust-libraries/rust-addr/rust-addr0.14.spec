...
%package     -n %{name}+no-std-net-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+no-std-net-devel %{_description}

This package contains library source intended for building other packages which
use the "no-std-net" feature of the "%{crate}" crate.

%files       -n %{name}+no-std-net-devel
%ghost %{crate_instdir}/Cargo.toml
